const intervalId = window.setInterval(function () {
    ...
    if (currentUrl.startsWith("https://steamdb.info")) {
        let increment;
        if (currentUrl === "https://steamdb.info/stats/gameratings/" || currentUrl === "https://steamdb.info/stats/gameratings/?all" || currentUrl.startsWith("https://steamdb.info/charts/") ) {
            increment = 7;
        } else {
            increment = 9;
        }
